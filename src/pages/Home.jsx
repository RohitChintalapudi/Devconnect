    ...
    <main className="-mt-15 ml-6">
      ...
      >
        <motion.p
          ...
          animate={{ opacity: 1 }}
          transition={{ duration: 1, ease: "easeOut" }}
          className="font-extrabold text-[47px] relative"
        >
          Front End Developer
        </motion.p>

        <p className="relative font-bold text-[18px] w-[700px] ">
          <b className="bg-purple-500"> I am Rohit - web developer </b> with a
          passion for creating beautiful and responsive websites. I specialize
          in transforming ideas into{" "}
          <b className="bg-cyan-400">interactive and user-friendly</b> digital
          experiences.
        </p>
        ...
        <div className="flex gap-4">
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.9 }}
            transition={{ duration: 1, ease: "easeOut" }}
            className="outline-2 w-30 p-2 inline-block rounded-xl backdrop-blur-md shadow-2xl 
           hover:shadow-purple-500 bg-white/30 font-bold relative top-4
          hover:backdrop-blur-2xl hover:shadow-2xl 
          hover:bg-gradient-to-br from-blue-700 via-violet-700 to-fuchsia-700 bg-opacity-80 
          cursor-pointer text-white drop-shadow-[0_0_20px_rgba(147,51,234,1)] text-center"
          >
            Download Resume
          </motion.a>
        </div>
